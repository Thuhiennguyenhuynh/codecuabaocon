...
<head>
  <title>Tiệm cà phê của Hinne</title>
  <meta charset="utf-8">
...
<link rel="shortcut icon" href="asset/images/avt/Hinne.png" type="image/x-icon">
      ...
      <div class="row py-4 pb-0 pb-sm-4 align-items-center ">
        ...
        <div
          ...
          <div class="support-box text-end d-none d-xl-block">
            ...
            <h5 class="mb-0">+84862962109</h5>
          </div>
          <div class="support-box text-end d-none d-xl-block">
            <span class="fs-6 secondary-font text-muted">Email</span>
            <h5 class="mb-0">thuhien.bae@gmail.com</h5>
          </div>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div class="offcanvas-body justify-content-between">
            ...
            <ul class="navbar-nav menu-list list-unstyled d-flex gap-md-3 mb-0">
              <li class="nav-item">
                <a href="<?= PATH ?>" class="nav-link active">Home</a>
              </li>
              ...
              <li class="nav-item">
                <a href="<?= PATH ?>page=product" class="nav-link">Product</a>
              </li>
              <li class="nav-item">
                <a href="<?= PATH ?>page=blog" class="nav-link">Blog</a>
              </li>
              <li class="nav-item">
                <a href="<?= PATH ?>page=contact" class="nav-link">Contact</a>
              </li>
              <li class="nav-item">
                <a href="<?= PATH ?>page=registration" class="nav-link">Registraion</a>
              </li>
            </ul>
